...
namespace SVL
{
	...
	class Renderer;
	//class PointLight;
	class DLLDIR Object final
	{
	public:
		Object(const Renderer& renderer, VkCommandPool command_pool, SVL::Mesh& mesh, SVL::Texture& texture);
		Object(const Renderer& renderer, VkCommandPool command_pool, std::vector<Mesh> meshes, std::vector<Material> materials);
		~Object();
